...
class LandingPage extends Component {
  ...
  fetchLandingPageData = (query) =>
    this.client.getEntries({ content_type: 'landingPage', include: 2 });
      ...
      <div className={'App-main'}>
        ...
        <HeadingContainer>
          <Heading
            ...
            mainTitle={'Go Travel'}
            subTitle={
              'We have the cheapest airline tickets and we are __IATA accredited agent__.\n' +
              'The best __travel package__ including __cruises__, and __special trips__.'
            }
            about={'Check our offer on [https://gotravel.ba/](https://gotravel.ba/ "GoTravel")'}
        ...
        {/*Tours*/}
        <ProductsContainer
          products={cardsData.filter((item) => !item.oneDayTour)}
          isMobile={isMobile}
        />
        {/*WHAT TO EXPECT*/}
        <HeadingContainer>
