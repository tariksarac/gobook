...
const CreateTour = ({ style, tourItem }) => {
    ...
    const options = ['Select your option','THE BEST OF BOSNIA & HERZEGOVINA TOUR', 'BEST OF BOSNIA', 'BOSNIA & HERZEGOVINA INTRO TOUR', 'DAILY TOUR IN MOSTAR AND POČITELJ', 'DAY TOUR IN VISOKO', 'DAY TOUR IN TRAVNIK AND JAJCE', 'HOSSZÚ HÉTVÉGE BOSZNIÁBAN']
    ...
    return (
        <div className={'create-tour'} style={{ ...style }}>
            ...
            <BookFormInput name={'ToUR NAME'} placeholder={'Bosnia and Herzegovina Intro Tour'} fullWidth />
            <BookFormInput name={'First name'} placeholder={'First name'} customStyle={{width:'50%'}}/>
