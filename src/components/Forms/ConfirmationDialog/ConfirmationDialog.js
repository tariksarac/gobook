...
const ConfirmationDialog = ({ open, handleClose, confirmationTitle, confirmationContent }) => {
  return (
    ...
    >
      <DialogTitle id="alert-dialog-title" style={{ textAlign: 'center', paddingTop: '100px' }}>
        {confirmationTitle}
      </DialogTitle>
      <DialogContent style={{ width: '250px', height: '50px', textAlign: 'center' }}>
        <DialogContentText id="alert-dialog-description">{confirmationContent}</DialogContentText>
      </DialogContent>
      <DialogActions>
