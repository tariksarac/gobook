...
const terms = '1. General\n\n' +
    ...
    'provisions set forth in package tour programs differ from the ones stipulated herein, the provisions\n' +
    'set forth in the programs shall prevail.\n' +
    'In case of telephone/internet sales, the travelers are considered to have accepted the general\n' +
    'terms and conditions once they make the order for the tour by telephone or online.\n' +
    'These general terms and conditions shall not apply to purchase of airline tickets and sales of\n' +
    'package tours organized by other tour operators where GoBook d.o.o. acts as an agent, in which\n' +
    'case the terms and conditions of the other tour operators or airlines as well as international\n' +
    ...
    'GoBook d.o.o. Visoko shall offer its services through its web site at www.gobook.ba. Based on\n' +
    'queries of individual parties, GoBook d.o.o. Visoko shall tailor one or more tour offers which shall\n' +
    ...
    'the traveler fails to cancel the tour within the specified deadline, either personally at the offices of\n' +
    'GoBook d.o.o. Visoko or in writing, they shall be deemed to have accepted the changed price. In\n' +
    'case of tour cancelation due to price increase exceeding 10%, the travelers shall not be entitled to\n' +
    'any compensation of damages. The travelers are bound to accept any price increase up to 10%.\n' +
    'The posted prices are the result of agreements between GoBook d.o.o. Visoko and its partners\n' +
    'and do not have to correspond to the prices displayed at the actual destination where the traveler\n' +
    'will be staying.\n' +
    ...
    'If the travelers fail to provide the information requested by the tour organizer, if they provide the\n' +
    'information late or if they provide false or incorrect information, the travelers themselves shall bear\n' +
    'the risk for complete or partial failure to carry out the tour. In the events when the tour cannot be\n' +
    'organized because of the travelers’ failure to fulfill their obligations, it shall be deemed that the\n' +
    'travelers have withdrawn from the contract and they shall suffer the consequences related to\n' +
    'withdrawing from the contract.\n' +
    'The travelers must possess a valid travel document with which they can enter a certain country.\n' +
    'The travelers have to be aware and comply with all legal provisions regarding the validity of their\n' +
    'travel documents. The requirements for validity of travel documents apply to the LAST day of the\n' +
    'tour! GoBook d.o.o. Visoko shall not be held liable or responsible for possible inconveniences or\n' +
    'forced trip interruption suffered by the travelers.\n' +
    ...
    'loss or theft of their documents, they are not entitled to any refunds.\n' +
    ...
    'GoBook d.o.o. Visoko shall take no responsibility for any verbal or written information which is not\n' +
    'in accordance with the description of services and accommodation facilities in the posted tour\n' +
    'programs.\n' +
    'Within visits to the towns specified in its tour programs, GoBook d.o.o. Visoko does not include\n' +
    'visits to interiors of public buildings, institutions or cultural monuments, except when it is expressly\n' +
    ...
    'damaged baggage shall be addressed by the traveler directly to the transport operator, police or\n' +
    'hotel. Transportation of special baggage (such as bicycle, surfboard, golf equipment, musical\n' +
    'instruments, etc.) has to be reported by the traveler while booking the fares and paid directly to\n' +
    'transport operator according to the applicable rules of the airline company, unless it is specified\n' +
    'otherwise in the package tour program. All costs or damages that might be incurred shall be borne\n' +
    'by the travelers themselves. If traveling by airplane, travelers are entitled to free baggage\n' +
    'allowance up to a certain size and weight (according to terms and conditions of individual airlines),\n' +
    'for each additional kilogram of baggage, the travelers have to pay an on-spot additional fee in the\n' +
    'appropriate currency, as provided for by terms and conditions of individual airline companies. The\n' +
    'maximum allowed weight of baggage to be registered at check-in is given before the journey\n' +
    'starts. For each additional kilogram, the travelers have to pay an additional fee. The allowed\n' +
    'weight/size of hand baggage that can be taken on board an airplane can vary, and travelers shall\n' +
    'be informed thereof before they depart on their journey.\n' +
    'Children regardless of their age have no right to free transport of baggage in air transport. In bus\n' +
    ...
    'a complaint about any errors or irregularities, it shall be deemed that the traveler has consented to\n' +
    'and accepted such service and they lose any right to subsequent claims or complaints. The\n' +
    'traveler can file a written complaint within two months after the service has been provided\n' +
    'incorrectly, otherwise they shall not be accepted and processed by GoBook d.o.o. Visoko. The\n' +
    ...
    'indisputably committed (even if the traveler failed to provide all the necessary documents within\n' +
    'the specified deadline) GoBook d.o.o. Visoko is bound to accept and comply with the complaint\n' +
    'claim. If the error is not simple, GoBook d.o.o. Visoko is bound to investigate all the circumstances\n' +
    'which have led to such an error. GoBook d.o.o. Visoko is entitled to postpone dispute resolution\n' +
    'for another 15 days in order to collect all the necessary information and check all the claims with\n' +
    'the service provider. Until GoBook d.o.o. Visoko makes a decision, and not longer than 30 days\n' +
    'after the written complaint is filed, the tour operator and the traveler waive any mediation by any\n' +
    'other institution or court and shall refrain from releasing any information to the media. Also, during\n' +
    'the course of the said 30-day period, the tour operator and the traveler waive their right to any\n' +
    'lawsuits.\n' +
    'The amount of damages, in case that program has not been carried out or a service provided due\n' +
    'to any mistake or error committed by GoBook d.o.o. Visoko, shall be restricted by the amount paid\n' +
    'for the tour and by the realistic value of services which have not been provided. This provision\n' +
    'does not apply to cases when GoBook d.o.o. Visoko has the right to cancel the tour or change the\n' +
    ...
    'GoBook d.o.o. Visoko is bound to provide to travelers all the services agreed for a specific\n' +
    'package tour as well as to provide all the answers in case it fails to provide a part of or a full\n' +
    'service. GoBook d.o.o. Visoko shall carry out all its obligations specified in a particular tour\n' +
    'program as they are described therein, except in case of “force majeure” or changed\n' +
    ...
    'communication and not to release or disclose the travelers’ personal information to any third\n' +
    'parties except for the express purposes of carrying out agreed package tours. The only exception\n' +
    'in which personal details can be provided to third parties is taking out insurance policies against\n' +
    'the risk of cancelation, insurance against accidents or health conditions, baggage insurance and\n' +
    'travel insurance. If a traveler takes out an insurance policy his/her personal details shall be\n' +
